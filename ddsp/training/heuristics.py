...
def midi_heuristic(controls):
  """A combination of heuristics for extracting discrete notes from DDSP controls."""
  return remove_short(
...
def midi_heuristic_power(controls):
  """A combination of heursitcs for extracting discrete notes from DDSP controls and power."""
  return remove_short(
